...
.s-row{display:grid;grid-template-columns:minmax(0,1fr) 64px 160px;padding:9px 16px;border-bottom:1px solid #f1f3f4;align-items:center;transition:background .15s}
